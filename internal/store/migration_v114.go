...
var agentCodeToolStatements = []string{
	...
	`ALTER TABLE file_edit_apply_results RENAME TO file_edit_apply_results_v113;`,
	`DROP INDEX idx_file_edit_apply_operations_run_created;`,
	`ALTER TABLE file_edit_apply_operations RENAME TO file_edit_apply_operations_v113;`,
	...
	`INSERT INTO file_edit_apply_operations
		...
		FROM file_edit_apply_operations_v113;`,
	...
	`INSERT INTO file_edit_apply_results
		...
		FROM file_edit_apply_results_v113;`,
	`DROP TABLE file_edit_apply_results_v113;`,
	`DROP TABLE file_edit_apply_operations_v113;`,
	...
	`ALTER TABLE run_supervisor_tool_calls RENAME TO run_supervisor_tool_calls_v113;`,
	...
	`INSERT INTO run_supervisor_tool_calls
		...
		FROM run_supervisor_tool_calls_v113;`,
	`DROP TABLE run_supervisor_tool_calls_v113;`,
