...
func (daemon *dockerWriteTestDaemon) inspectPayload() []byte {
	...
	payload := map[string]any{
		...
		"Config": map[string]any{
			...
			"AttachStdin":  daemon.payload.AttachStdin,
			"AttachStdout": daemon.payload.AttachStdout,
			"AttachStderr": daemon.payload.AttachStderr,
			"OpenStdin":    daemon.payload.OpenStdin, "StdinOnce": daemon.payload.StdinOnce,
			"Tty":    daemon.payload.Tty,
