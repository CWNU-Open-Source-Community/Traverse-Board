...
| [#164](https://github.com/CWNU-Open-Source-Community/Traverse-Board/issues/164) | Clean-install consolidated schema baseline | No legacy squash, renumbering, or checksum rewrite |
