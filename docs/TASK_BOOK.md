...
- [x] P10-H1/H2/H3 三切片功能门：最终全仓普通 Go 435.4 秒、Analyzer ordinary/race、vet、零告警 staticcheck 与 Linux 无 CGO 交叉编译通过；race 审查修复 Windows SID integrity 解析在 checkptr 下的内部指针问题，schema v92 与产品入口保持不变。
